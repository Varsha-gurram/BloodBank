            ...
            >
              <thead>
                <tr style={{ background: "#eaf1fb" }}>
                  <th scope="col" style={{ color: "#344767", fontWeight: 600 }}>Blood Group</th>
                  <th scope="col" style={{ color: "#344767", fontWeight: 600 }}>Inventory Type</th>
                  <th scope="col" style={{ color: "#344767", fontWeight: 600 }}>Quantity</th>
                  <th scope="col" style={{ color: "#344767", fontWeight: 600 }}>Donor Email</th>
                  <th scope="col" style={{ color: "#344767", fontWeight: 600 }}>Time & Date</th>
                </tr>
              </thead>
              <tbody>
                {data?.map((record) => (
